...
$directions =
"# Generated by HyperC's headerimport.php file based on the following\n".
"# framework headers:\n";	// Continues below.
...
{
	$frameworks = array( "CoreFoundation", "ApplicationServices", "Carbon", "Foundation", "AppKit", "WebKit", "AddressBook", "QTKit", "ScreenSaver", "Message/NSMailDelivery.h" );
...
"# is on that line. An asterisk (*) indicates this is the name of the class the\n".
"# following lines and categories belong to. A colon (:) indicates the super-\n".
"# class of the current class. An opening bracket indicates that the following\n".
"# methods are from a category with that particular name. A less-than sign (<)\n".
"# indicates a protocol that the current class/category implements. There may\n".
"# be several protocols, each specified on its own line.\n# \n".
...
"# future expansion like adding functions and other data types.\n# \n".
...
$srcfilename = tempnam("/file/does/never/exist","hyperc_headerimport");
$headerdatafilename = tempnam("/file/does/never/exist","hyperc_headerimport");
$headerdatafilename = "/Users/uli/Programming/HyperC/preparedheaders.h";
